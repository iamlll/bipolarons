...
print(nag.min_E_bip_ln2(tuple(np.array([0.015789474, 47.92674633, 10.,0.6,500.]))))
...
#print(nag.E_bip_aysfix(tuple(np.array([np.log(0.160376926), 7.389056099,0.012882568,0.015789474,47.92674633,10.,0.6])))) #(s, y, a, n, U, z_c, a_c)
#print(nag.E_bip_aysfix(tuple(np.array([np.log(0.160376926),70.,0.012882568,0.015789474,47.92674633,10.,0.6])))) #(s, y, a, n, U, z_c, a_c)
#print(nag.E_bip_aysfix(tuple(np.array([np.log(0.194), 5000.,0.0,0.,39.,10.,0.6])))) #(s, y, a, n, U, z_c, a_c)

#print(nag.min_E_bip_ln2(tuple(np.array([0.047,52.,10.,0.6]))))
#print(nag.min_E_bip_yfix_ln(tuple(np.array([0.047,52.,10.,0.6,100.]))))
#print(nag.min_E_bip_yfix_ln(tuple(np.array([0.047,52.,10.,0.6,1.02]))))
...
#print(timeit.timeit(stmt="nag.TestZInt(y, 1., 0.00001, 0.,1.)",setup=setupstr,number=5))
#print(timeit.timeit(stmt="nag.Eph_inf_ln(1.,0.00001,y, 0.,1.,10.,0.6)",setup=setupstr,number=5))
